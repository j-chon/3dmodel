...
<head>
    ...
    <meta http-equiv="Cache-Control" content="no-cache, no-store, proxy-revalidate">
...
<div id="reserveWrapper">
    ...
    <div id="reserveContents">
        ...
        <form id="bt_reserveActionForm" method="post"
            ...
            <table cellspacing="0" class="wFull bdCell  mT10">
                ...
                <tr>
                    <th class="w170 bgLGray fw_bold">
                        <div class="dibBL vaM fw_normal iconMustEmpty mR10">&nbsp;</div>
                ...
                <tr>
                    <th class="w170 bgLGray fw_bold taC">
                        <div class="dibBL vaM">サロンからのメッセージ</div>
                    </th>
                    <td class="lh18">
                        <div class="dibBL vaM w150">
                            <input type="checkbox" name="rsvCmReceive" value="${reserveForm.isMailMagazineReceive}"
                                   checked="checked" id="forRsvcmReceive"
                                   class="cbF"><label for="forRsvcmReceive">受け取る</label>
                        </div>
                        <div class="fgOrange dibBL vaM fs10 pR5 pL1e txt1e">
                            ※サロンからのメッセージがマイページに届きます。メッセージ自体を受けとりたくない場合はマイページから解除出来ます。
                        </div>
                    </td>
                </tr>
                </tbody>
            ...
            <div class="yS reserveTitleOuter mT20">
                <h3 class="yS reserveTitleInner pL10 fw_bold">サロンからお客様への確認事項</h3>
            </div>
            <table cellspacing="0" class="wFull bdCell mT10">
                <tbody>
                <tr>
